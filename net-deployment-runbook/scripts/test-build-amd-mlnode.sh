...
grep -Fq 'PLAN source.vllm=https://github.com/gonka-ai/vllm.git@5110f7fcf176100d1c29c9ea0c75efbf271ec4b3' <<<"$plan"
...
grep -Fq 'VLLM_ROCM_USE_AITER=0' "$ROOT/images/Dockerfile.mlnode-rocm"

...
run_reset() {
  local home="$1" alias="$2" remote_script="$3"
  env -u GDC_ENV -u GDC_NODE_ALIASES GDC_HOME="$home" \
    GDC_TEST_REMOTE_SCRIPT="$remote_script" GDC_TEST_SSH_LOG="$tmp/ssh.log" PATH="$fake_bin:$PATH" \

...
grep -Fq 'BOT_API_BASE_URL="http://127.0.0.1:18080/v1"' "$deploy"
...
grep -Fq 'Telegram consumer probe endpoint=http://127.0.0.1:18080/v1/chat/completions reason=%s' "$deploy"

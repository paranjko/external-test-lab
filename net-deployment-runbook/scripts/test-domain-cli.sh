...
grep -Fq 'https://gonka-dev.net/bootstrap/gonka-devnet-community.json' "$ROOT/gdc.sh"
grep -Fq 'network bootstrap verify FILE' "$ROOT/gdc.sh"
grep -Fq 'wget https://gonka-dev.net/v1.bootstrap.schema.json' "$ROOT/ROLE-JOIN.md"
...
grep -Fq 'wget https://gonka-dev.net/bootstrap/gonka-devnet-community.json' "$ROOT/ROLE-JOIN.md"
grep -Fq 'Testnet is intentionally unavailable' "$ROOT/ROLE-JOIN.md"
grep -Fq 'Do not substitute a' "$ROOT/ROLE-JOIN.md"
grep -Fq 'Mainnet document or use a placeholder.' "$ROOT/ROLE-JOIN.md"
grep -Fq 'gh attestation verify v1.bootstrap.schema.json -R paranjko/external-test-lab' "$ROOT/ROLE-JOIN.md"
grep -Fq 'gdc network bootstrap verify gonka-devnet-community.json' "$ROOT/ROLE-JOIN.md"
grep -Fq 'gdc host join --bootstrap-file gonka-devnet-community.json' "$ROOT/ROLE-JOIN.md"

...
grep -Fq 'GDC_GATEWAY_CONTINUITY_REQUEST_TIMEOUT_SECONDS:-270' "$ROOT/scripts/phase-gateway-continuity.sh"
grep -Fq 'GDC_GATEWAY_ADMISSION_MAX_WAIT_SECONDS", 240' "$ROOT/04-ops/edge-node/gateway-admission-proxy.py"
grep -Fq 'GDC_GATEWAY_ADMISSION_MAX_WAIT_SECONDS=${GDC_GATEWAY_ADMISSION_MAX_WAIT_SECONDS:-240}' "$ROOT/04-ops/edge-node/render-env.sh"

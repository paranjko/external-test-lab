...
# A Host owns one validator. Recovery observes the same flat layout rendered
# by JOIN; templates remain overrides solely for the frozen incident rehearsal.
RECOVERY_REMOTE_COMPOSE_DIR_TEMPLATE="${RECOVERY_REMOTE_COMPOSE_DIR_TEMPLATE:-/srv/dai/deploy}"
RECOVERY_REMOTE_SOURCE_HOME_TEMPLATE="${RECOVERY_REMOTE_SOURCE_HOME_TEMPLATE:-/srv/dai/data/inference}"
RECOVERY_REMOTE_TMKMS_STATE_TEMPLATE="${RECOVERY_REMOTE_TMKMS_STATE_TEMPLATE:-/srv/dai/signer/tmkms/state/priv_validator_state.json}"

...
export GDC_JOIN_BOOTSTRAP_MODE GDC_JOIN_TRUST_HEIGHT GDC_JOIN_TRUST_HASH GDC_JOIN_SNAPSHOT_HEIGHT GDC_JOIN_LINEAGE_RECEIPT_SHA256
...
grep -qx "join_snapshot_height=$GDC_JOIN_SNAPSHOT_HEIGHT" "$manifest"
...
grep -Fq 'lineage preflight join_snapshot_height' "$tmp/snapshot.err"
